...
-   `readLibro(id: string) : Promise<ILibro|null>` Obtiene el libro con ese id, si no lo encuentra entonces devuelve null.
-   `readLibros() : Promise<ILibro[]|[]>` Obtiene todos los libros.
